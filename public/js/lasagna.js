...
var LasagnaActivityLogElement = (function (_super) {
    ...
    LasagnaActivityLogElement.prototype.renderActivities = function (activities) {
        ...
        return (_a = ["", "<lasagna-activity-log-activity></lasagna-activity-log-activity>"], _a.raw = ["", "<lasagna-activity-log-activity></lasagna-activity-log-activity>"], diffhtml_1.html(_a, elements));
        var _a;
...
var LasagnaActivityLogActivityElement = (function (_super) {
    ...
    LasagnaActivityLogActivityElement.prototype.render = function () {
        ...
        diffhtml_1.innerHTML(this.shadowRoot, (_a = ["\n      <style>\n      </style>\n      <form>\n        <!--<label>\n          <input type=\"text\" value=\"", "\" placeholder=\"Task name\">\n        </label>\n        <label>\n          <input type=\"time\" value=\"", "\">\n        </label>\n        <label>\n          <input type=\"time\" value=\"", "\">\n        </label>\n        <label>\n          <input type=\"text\" value=\"", "\">\n        </label>-->\n      </form>\n    "], _a.raw = ["\n      <style>\n      </style>\n      <form>\n        <!--<label>\n          <input type=\"text\" value=\"", "\" placeholder=\"Task name\">\n        </label>\n        <label>\n          <input type=\"time\" value=\"", "\">\n        </label>\n        <label>\n          <input type=\"time\" value=\"", "\">\n        </label>\n        <label>\n          <input type=\"text\" value=\"", "\">\n        </label>-->\n      </form>\n    "], diffhtml_1.html(_a, activity.task, activity.stopped, activity.stopped, formatDuration(computeDuration(activity.started, activity.stopped)))));
        console.log(this.shadowRoot.innerHTML);
        var _a;
    };
